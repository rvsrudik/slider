...
sliderTab.push(CreateSlideObj("img/user1.png", "New Providence is the great UI kit", "Just then her head struck against the roof of the hall: in fact she was now more than nine feet high, and she at once took up the little golden key and hurried off to the garden door.", 2, "Cameron Dowman"));
sliderTab.push(CreateSlideObj("img/user2.png", "Sebe derni", "W3Schools is optimized for learning, testing, and training. Examples might be simplified to improve reading and basic understanding. Tutorials, references, and examples are constantly reviewed to avoid errors, but we cannot warrant full correctness of all content.", 5, "Pes Sobaka"));
sliderTab.push(CreateSlideObj("img/user3.png", "The background-image", "Property sets one or more background images for an element By default, a background-image is placed at the top-left corner of an element, and repeated both vertically and horizontally.", 3, "Vitya Howard"));
sliderTab.push(CreateSlideObj("img/user4.png", "Designed and built" ,"With all the love in the world by @mdo and @fat. Maintained by the core team with the help of our contributors. Currently v4.0.0-alpha.6. Code licensed MIT, docs CC BY 3.0.", 1, "Divan Vovan"));
...
right_arrow.on("click", function () {
    ...
    //     queue: false
    // }, 400);
    // $(".side_pic:nth-child(2)").animate({
    //     opacity: '0.0',
    //     queue: false
    // }, 400);
    // $(".side_pic:nth-child(4)").animate({
    //     opacity: '0.0',
    //     queue: false
    // }, 400, function() {
...
left_arrow.on("click", function () {
    ...
    //     opacity: '1.0'
    // }, 400);
    // // $(".side_pic:nth-child(2)").fadeIn(1000);
    // $(".side_pic:nth-child(2)").animate({
    //     left: '+=5%'
    // }, 0);
    // $(".side_pic:nth-child(2)").animate({
